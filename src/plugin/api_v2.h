// api_v2.h
#ifndef _API_V2_H_INCLUDE_
#define _API_V2_H_INCLUDE_
...
} WINAMP_GENDATA, *HWINAMP_GENDATA;

#define GPPHDR_VER 0x10

extern HWINAMP_GENDATA	gen_plugins[256];
typedef HWINAMP_GENDATA	(*winampGeneralPurposePluginGetter)();
...
#define IDC_NGWINAMP_PLSORTBYNAME	40209
#define IDC_NGWINAMP_PLSORTBYPATH	40211
#define IDC_NGWINAMP_PLRANDOMIZE	40212
#define IDC_NGWINAMP_PLREMOVEDEAD	40222
...
// structure d'ajout / insertion de fichier
typedef struct {
	char file[MAX_PATH];
	int  index;
} PE_FILEINFO;
...
// structure d'échange du plugin winamp (general)
typedef struct {
	int				version;
	char*			description;
	int				(*init)();
